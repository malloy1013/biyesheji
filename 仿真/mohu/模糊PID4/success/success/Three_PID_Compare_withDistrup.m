function varargout = Three_PID_Compare_withDistrup(varargin)
% THREE_PID_COMPARE_WITHDISTRUP M-file for Three_PID_Compare_withDistrup.fig
%      THREE_PID_COMPARE_WITHDISTRUP, by itself, creates a new THREE_PID_COMPARE_WITHDISTRUP or raises the existing
%      singleton*.
%
%      H = THREE_PID_COMPARE_WITHDISTRUP returns the handle to a new THREE_PID_COMPARE_WITHDISTRUP or the handle to
%      the existing singleton*.
%
%      THREE_PID_COMPARE_WITHDISTRUP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in THREE_PID_COMPARE_WITHDISTRUP.M with the given input arguments.
%
%      THREE_PID_COMPARE_WITHDISTRUP('Property','Value',...) creates a new THREE_PID_COMPARE_WITHDISTRUP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Three_PID_Compare_withDistrup_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Three_PID_Compare_withDistrup_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Three_PID_Compare_withDistrup

% Last Modified by GUIDE v2.5 29-May-2010 15:27:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Three_PID_Compare_withDistrup_OpeningFcn, ...
                   'gui_OutputFcn',  @Three_PID_Compare_withDistrup_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Three_PID_Compare_withDistrup is made visible.
function Three_PID_Compare_withDistrup_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Three_PID_Compare_withDistrup (see VARARGIN)

% Choose default command line output for Three_PID_Compare_withDistrup
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Three_PID_Compare_withDistrup wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Three_PID_Compare_withDistrup_OutputFcn(hObject, eventdata, handles) 
...
load_system('PIDController_1_r');

%set parameters of simulink mdl file
set_param('PIDController_1_r/PID','Kp','Kp_gui','Ki','Ki_gui','Kd','Kd_gui');
sim('PIDController_1_r.mdl',[],simset('DstWorkspace ','base')); 
...
load_system('Fuzzy_PID_1_r')

set_param('Fuzzy_PID_1_r/PID','Kp','Kp_gui','Ki','Ki_gui','Kd','Kd_gui');
set_param('Fuzzy_PID_1_r/FuzPID','Kp','Kp_gui','Ki','Ki_gui','Kd','Kd_gui','dKp','dKp_gui','dKi','dKi_gui','dKd','dKd_gui','Ke','1','Kec','1/derror_max');

%run Fuzzy_PID file
sim('Fuzzy_PID_1_r.mdl',[],simset('DstWorkspace ','base')); 
...
%%%%%%%%%%%%%%%%%%%%%%RBF NN PID%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Ut3_gui=zeros(10001,1);
Ut3_gui(2:10001)=yout;
assignin('base','Ut3_gui',Ut3_gui);
