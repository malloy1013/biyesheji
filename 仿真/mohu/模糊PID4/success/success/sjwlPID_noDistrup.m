function varargout = sjwlPID_noDistrup(varargin)
% SJWLPID_NODISTRUP M-file for sjwlPID_noDistrup.fig
%      SJWLPID_NODISTRUP, by itself, creates a new SJWLPID_NODISTRUP or raises the existing
%      singleton*.
%
%      H = SJWLPID_NODISTRUP returns the handle to a new SJWLPID_NODISTRUP or the handle to
%      the existing singleton*.
%
%      SJWLPID_NODISTRUP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SJWLPID_NODISTRUP.M with the given input arguments.
%
%      SJWLPID_NODISTRUP('Property','Value',...) creates a new SJWLPID_NODISTRUP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before sjwlPID_noDistrup_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to sjwlPID_noDistrup_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help sjwlPID_noDistrup

% Last Modified by GUIDE v2.5 30-May-2010 12:37:03

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @sjwlPID_noDistrup_OpeningFcn, ...
                   'gui_OutputFcn',  @sjwlPID_noDistrup_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before sjwlPID_noDistrup is made visible.
function sjwlPID_noDistrup_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to sjwlPID_noDistrup (see VARARGIN)

% Choose default command line output for sjwlPID_noDistrup
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes sjwlPID_noDistrup wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = sjwlPID_noDistrup_OutputFcn(hObject, eventdata, handles) 
